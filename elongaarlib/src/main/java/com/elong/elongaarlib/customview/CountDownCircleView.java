...
public class CountDownCircleView extends View {
    ...
    private static final int DEF_ANIMATION_TIME = 3000;
    ...
    private void initData() {
        ...
        countDownTime = DEF_ANIMATION_TIME;
    }
    ...
    private void initAttrWithStyle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        circleBgColor = typedArray.getColor(R.styleable.CountDownCircleView_circle_bg_color, Color.BLACK);
        circlePbColor = typedArray.getColor(R.styleable.CountDownCircleView_circle_pb_color, Color.BLACK);
        circlePbWidth = typedArray.getDimensionPixelOffset(R.styleable.CountDownCircleView_circle_pb_width, 0);
        circleTextColor = typedArray.getColor(R.styleable.CountDownCircleView_circle_text_color, Color.BLACK);
        circleTextSize = typedArray.getDimensionPixelSize(R.styleable.CountDownCircleView_circle_text_size, 0);
        typedArray.recycle();
    }
